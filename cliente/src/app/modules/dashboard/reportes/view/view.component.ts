...
export class ViewComponent implements OnInit {
  ...
  selectionCompetencia(competencias: any): void {
    console.log('Competencias seleccionadas', competencias);
  }
  selectionGrupo(grupos: any): void {
  ...
  generarReporte(): any {
    ...
    this.factory
      ...
      .subscribe((res: any): any => {
        ...
        res.data[0].personas.forEach((element: any) => {
          let suma = 0;
          element.resultados.forEach((item: any) => {
  ...
  graficar(grafica?: any): void {
    const graficaHtl: any = document.getElementById('gra');
    graficaHtl.innerHTML += '<canvas id="myChart"></canvas>';
